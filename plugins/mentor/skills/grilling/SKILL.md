...
> **`/plan-review`** audits the *finished plan* — staged reviewer agents (a judgment pass whose edits you pick at a fold gate, then a mechanical pass whose safe fixes are auto-folded) at the approve gate, no human interview.
