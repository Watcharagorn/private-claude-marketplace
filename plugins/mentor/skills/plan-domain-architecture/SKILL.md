...
description: >
  ...
  diagram is reserved for the opt-in HTML zoom (`mentor:zooming`).
---
...
for connectors — self-contained per `mentor:zooming` Step 3. The `.md` plan stays the source of truth.
